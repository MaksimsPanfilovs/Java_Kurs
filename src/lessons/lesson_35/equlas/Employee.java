...
public class Employee {
    ...
    public boolean equals(Object obj) {
        ...
        // Сравнение значения полей, которые должны быть равными, для признания объектов равными.
...
//                && dateOfBirth.equals(employee.dateOfBirth);
        ...
        // Object.equals(null, employee.firstName); -> просто вернет false.

        // Безопасное сравнение объектов с учетом возможности появление null - значения
