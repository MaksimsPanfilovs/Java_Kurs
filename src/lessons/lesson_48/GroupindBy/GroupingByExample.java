...
//                .collect(Collectors.groupingBy(emp -> emp.getDepartament()));
        ...
        // Коллектор для значений. В какую коллекцию собирать значения, соответсвующее ключу.
        ...
        map2 = employees.stream()
                .collect(Collectors.groupingBy(Employee::getDepartament, LinkedHashMap::new, Collectors.toSet()));
