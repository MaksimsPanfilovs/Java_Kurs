...
public class MapExample {
    public static void main(String[] args) {
        ...
        // V put(K key, V value) -> возвращает старое значение, соответсвующее ранее этому ключу.
        ...
        book2.put("Sebastian", "+49-66666");
        book2.put("Michael", "+49-99999");
        ...
        System.out.println("phoneBook.containsKey(\"1234\"): " + phoneBook.containsKey("1234"));
        System.out.println("phoneBook.containsValue(\"+49-99999\"): " + phoneBook.containsValue("+49-99999"));


        System.out.println("=================== GET =================");

        // Взятие значения по ключу.
        // V get(K key) - возвращает значение по ключу, если ключа нет - возвращает null.
        ...
        // Конструкторы
        // 16 корзин, коэффициент заполнение 0.75.
        Map<Integer, String> construct = new HashMap<>(); // Создается пустой список пар ключ-значение.
        construct = new HashMap<>(30); // Создается пустой словарь. 32 корзины. Коэффициент заполнение 0.75.
        construct = new HashMap<>(32, 0.90f); // Создается пустой словарь. 32 корзины. Коэффициент заполнение 0.90.
