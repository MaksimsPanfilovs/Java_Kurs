...
public class ListExample {
    public static void main(String[] args) {
        ...
        List<Integer> list = new ArrayList<>(); // Создает пустой список (с начальной ёмкостью 10 элементов).
        list = new ArrayList<>(50); // Пустой список с указанной ёмкостью.
        ...
        // boolean remove(Object obj) - метод удаление по значению (из интерфейса Collection) - принимает ссылочный тип данных.
        ...
        // int lastIndexOf(Object obj) - последние вхождение.
