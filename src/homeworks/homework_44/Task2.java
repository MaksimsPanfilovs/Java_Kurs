...
public class Task2 {
    ...
    private static <T> List<T> union(Set<T> set1, Set<T> set2) {
        //
    ...
    private static <T> List<T> intersection(Set<T> set1, Set<T> set2) {
        return null;
    }

    private static <T> List<T> difference(Set<T> set1, Set<T> set2) {
        return null;
    }
